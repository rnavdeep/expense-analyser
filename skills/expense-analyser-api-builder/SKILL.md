...
description: Build or extend API integrations in the expense-analyser Vue frontend. Use when adding a new backend endpoint or API-driven feature and you need to update this project's models, axios service methods, Pinia store actions/state, and UI wiring consistently across src/models, src/services, src/stores, and src/components or src/views.
---
